...
```{r eval=TRUE,echo=FALSE,cache=TRUE,message=FALSE,results='hide',warning=FALSE,error=FALSE}
...
```{r plotws,eval=TRUE,echo=FALSE,cache=TRUE,results='hide',fig.show=FALSE,fig.keep='all',include=FALSE,fig.width=7,fig.height=6,message=FALSE,warning=FALSE,error=FALSE}
for(i in 1:length(G)){
