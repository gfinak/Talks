...
```{r opencyto, echo=FALSE,cache=FALSE,eval=TRUE,results='hide',message=FALSE,warning=FALSE,error=FALSE,fig.width=8,fig.height=8,out.height='600px',out.width='800px',include=FALSE}
suppressPackageStartupMessages(require(openCyto))
g<-G[[5]]
plotGate(g[[2]],xbin=FALSE)
plotGate(g[[2]],6,xbin=128)
...
plotGate(g[[2]],15,xbin=128)
plot(g[[2]],boolean=TRUE)
plotGate(g[[2]],c(3,4,5,15,11,12,13,14,19,7,6),xbin=FALSE)
```
